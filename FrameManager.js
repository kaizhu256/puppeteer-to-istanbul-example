...
const {ExecutionContext, EVALUATION_SCRIPT_URL} = require('puppeteer/lib/ExecutionContext');
const {LifecycleWatcher} = require('puppeteer/lib/LifecycleWatcher');
const {DOMWorld} = require('puppeteer/lib/DOMWorld');
const {NetworkManager} = require('puppeteer/lib/NetworkManager');
